...
function Navbar() {
    ...
    return (
        <IconContext.Provider value={{ color: "#fff" }}>
            <div className="Menu">
                <div className={"m-logo"} onClick={() => setOpenMenu(!openMenu)}>
                ...
                <div className={setClassNames(3)} onClick={() => pushToRoute("/profile")}>
                    Profile
                </div>
                <div className={setClassNames(4)} onClick={() => pushToRoute("/list")}>
                    List
                </div>
            </div>
